...
export function initializeObjectivesSpacePanel(config) {
    const { data, objectiveDirections = {}, chartRegistry, renderOptions = {}, onAfterRender, groups = {}, measures = {}, frontierOrder = null, disabledCharts = null, forceEmptyState = false, emptyStateText = null } = config;
